...
class Cart extends Component {
    ...
    isClick = (e) => {
        ...
        if (name === undefined || phone === undefined || cmnd === undefined || tp === undefined || address === undefined || quan === undefined) {
                                    ...
                                    {this.state.item.map((x, key) =>
                                        <tr key={key} >
                                            ...
                                            <td><div className="form-group">
                                                <select onChange={(e, id) => this.onChose(e, x.productid, x.price)} className="form-control" defaultValue={x.typeorder} name="typeorder">
                                            ...
                                            <td>  <div className="text-danger" onClick={(id) => this.remove(x.productid)} ><i className="far fa-times-circle"></i></div></td>
                            ...
                            {/* <div className="row">
                                <div className="col-md-4 col-12">
                                    <div className="form-group ">
                                        <label >Tên</label>
                                        <input type="text"
                                            className="form-control" onChange={(e) => this.ischange(e)} required name="name" defaultValue={this.state.user.name } />
                                    </div>
